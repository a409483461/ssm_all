...
<c:set var="picPath" value="http://127.0.0.1:8081/ssm_image"></c:set>
...
<tr>
	...
	<td>
		...
		<input type='file' id='imgSize1File' name='imgSize1File' class="file" onchange='submitImgSize1Upload()' value="" /><span class="pos" id="imgSize1FileSpan">请上传图片的大小不超过3MB</span>
